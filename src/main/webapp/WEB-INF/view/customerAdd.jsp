...
<script type="text/javascript">
			...
			<script type="text/javascript">
                $(function () {
                    $("#customername").blur(function () {
                        ...
                        if (customername!=""){
                            $.ajax({
                                url:'${pageContext.request.contextPath}/customer/customerName.action'
	...
	<form action="${pageContext.request.contextPath}/customer/customerAdd.action" method="post" name="form1" onsubmit="return check();">
    	<table align="center" border="1" cellpadding="2" cellspacing="1">
    		<tr>
    			<td align="right">客户名称：</td>
    			<td><input type="text" name="customername" id="customername">&nbsp;&nbsp;&nbsp;<font color="red"><span id="name">*公司名称，必填</span></font><font size="2" color="red"></font></td>
