...
<body>
    ...
    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <script language="javascript">
                ...
                <script type="text/javascript">
                    ...
                    layui.use('layer', function(){
                        ...
                        var customertypeAdd='${customertypeAdd}';
                        if(customertypeAdd!=""){
                            layer.open({
                                title:0
                                ,content:customertypeAdd
                                ,skin: 'demo-class'
                                ,offset: 'auto'
                                ,anim: 1
                                ,time:2000
                            })
                            if(customertypeAdd=="添加成功"){
            ...
            <form action="${pageContext.request.contextPath}/customertype/customertypeAdd.action" method="post" name="form1" onsubmit="return check();">
            <table width="70%" border="0" align="left" cellpadding="2" cellspacing="1" >
			  <tr>
			    ...
			    <td class="STYLE1"  style="BORDER-BOTTOM: #c1dad7 1px solid"><input type="text" name="customertypename" id="customertypename"> &nbsp;&nbsp;&nbsp;<font color="red"><span id="name"></span></font></td>
			  </tr>
			   <tr>
