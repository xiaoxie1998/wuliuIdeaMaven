...
<body>
    ...
    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td width="70%">
                <p class="left_txt2">运输车辆资料列表&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
            </td>
            <td width="20%" align="right">
            <div align="center">
                <c:forEach items="${listAcc}" var="accmoudle">
                    <c:if test="${accmoudle.module.moduleid==12}">
                        <img src="${pageContext.request.contextPath}/images/ico_Form.gif" width="14" height="14" />&nbsp;<a href='${pageContext.request.contextPath}/load/transCarAdd.action' >新增</a>&nbsp;&nbsp;&nbsp;&nbsp;
                    </c:if>
                </c:forEach>
	    	...
	    	<tr>
               ...
               <script>
                   ...
                   layui.use('table', function(){
                       ...
                       table.render({
                           elem: '#demo'
                           ,url: '${pageContext.request.contextPath}/transcar/transcarPage.action' //数据接口
                           ,page: true //开启分页
                           ,limit:5
                           ,limits:[5,10,15,20]
                           ,cols: [[ //表头
                       ...
                       table.on('tool(test)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                           ...
                           if(layEvent === 'transCarUpdate'){ //修改
                               location.href="${pageContext.request.contextPath}/load/transCarUpdate.action?id="+data.transid;
                               //do somehing
                               ...
                               layer.confirm('真的删除行么', function(index){
                                   ...
                                   //向服务端发送删除指令
                                   $.ajax({
                                       url:'${pageContext.request.contextPath}/transcar/transCarDelete.action'
               ...
               <script type="text/html" id="barDemo">
                   ...
                   <c:forEach items="${listAcc}" var="accmoudle">
                       <c:if test="${accmoudle.module.moduleid==13}">
                           <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="delete">删除</a>
                       </c:if>
                       <c:if test="${accmoudle.module.moduleid==14}">
                           <a class="layui-btn layui-btn-xs" lay-event="transCarUpdate">修改</a>
                       </c:if>
