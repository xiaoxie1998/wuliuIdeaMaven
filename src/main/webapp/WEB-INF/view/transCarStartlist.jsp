	    	...
	    	<tr>
			   ...
			   <script>
                   ...
                   layui.use('table', function(){
                       ...
                       table.render({
                           elem: '#demo'
                           ,url: '${pageContext.request.contextPath}/transcar/transcarCusPage.action?status=1' //数据接口
                           ,page: true //开启分页
                           ,limit:5
                           ,limits:[5,10,15,20]
                           ,cols: [[ //表头
                       ...
                       table.on('tool(test)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                           ...
                           if(layEvent === 'carDetail'){ //明细
                               ...
                               //do somehing
                           } else if(layEvent === 'transStatus'){ //发车

                               layer.confirm('真的发车么', function(index){


                                   //向服务端发送删除指令
                                   $.ajax({
                                       url:'${pageContext.request.contextPath}/transcar/transcarUpdateStatus.action?status=2'
			   ...
			   <script type="text/html" id="barDemo">
                   ...
                   <c:forEach items="${listAcc}" var="accmoudle">
                       <c:if test="${accmoudle.module.moduleid==17}">
                           <a class="layui-btn layui-btn-xs" lay-event="transStatus">发车</a>
                       </c:if>
