					...
					<table style="width: 100%;" border="0" cellpadding="0"
						...
						<tr>
							<td colspan="2"><script language="javascript">
                                        ...
                                        if(areaUpdate!=""){
                                            ...
                                            if(areaUpdate=="修改成功"){
                                                window.setTimeout(function () {
                                                    location.href="${pageContext.request.contextPath}/load/arealist.action";
                                                },1000)
                                            }
                                        }
                                    })
								...
								<script type="text/javascript">
                                    $(function () {
                                        var areaname2='${area.areaname }'; //获取原来区域名称
                                        $("#areaname").blur(function () {
                                            var areaname=$(this).val().trim();
                                            if (areaname!=""&&areaname!=areaname2){
                                                $.ajax({
                                                    url:'${pageContext.request.contextPath}/area/areaName.action'
								...
								<form
									action="${pageContext.request.contextPath}/area/areaUpdate.action"
									...
									<table width="70%" border="0" align="left" cellpadding="2"
										...
										<tr>
											...
											<td class="STYLE1" style="BORDER-BOTTOM: #c1dad7 1px solid"><input
												type="text" name="areaname" id="areaname" value="${area.areaname }">&nbsp;&nbsp;&nbsp;<font color="red"><span id="name"></span></font></td>
										</tr>
										<tr>
											<td width="130" height="30" class="STYLE1" nowrap="nowrap"
												style="BORDER-BOTTOM: #c1dad7 1px solid"><div
