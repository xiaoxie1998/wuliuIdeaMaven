...
<body>
    ...
    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <script language="javascript">
                ...
                <script type="text/javascript">
                    ...
                    layui.use('layer', function(){
                        ...
                        var sendtypeUpdate='${sendtypeUpdate}';
                        if(sendtypeUpdate!=""){
                            layer.open({
                                title:0
                                ,content:sendtypeUpdate
                                ,skin: 'demo-class'
                                ,offset: 'auto'
                                ,anim: 1
                                ,time:2000
                            })
                            if(sendtypeUpdate=="修改成功"){
                ...
                <script type="text/javascript">
                    $(function () {
                        var sendtypename2='${send.sendtypename }'; //获取原来区域名称
                        $("#sendtypename").blur(function () {
                            var sendtypename=$(this).val().trim();
                            if (sendtypename!=""&&sendtypename!=sendtypename2){
                                $.ajax({
            ...
            <form action="${pageContext.request.contextPath}/sendtype/sendtypeUpdate.action" method="post" name="form1" onsubmit="return check();">
            ...
            <table width="70%" border="0" align="left" cellpadding="2" cellspacing="1" >
			  <tr>
			    ...
			    <td class="STYLE1"  style="BORDER-BOTTOM: #c1dad7 1px solid"><input type="text" name="sendtypename" value="${send.sendtypename }" id="sendtypename">&nbsp;&nbsp;&nbsp;<font color="red"><span id="name"></span></font></td>
			  </tr>
			   <tr>
