						...
						<td colspan="2">
							...
							<script>
                                ...
                                layui.use('table', function(){
                                    ...
                                    table.render({
                                        elem: '#demo'
                                        ,url: '${pageContext.request.contextPath}/cardetail/cardetailModifyPage.action' //数据接口
										,method:"post"
										,where:{'detailid':'${cardetail.detailid}',
                                            'transcar.transid':'${cardetail.transcar.transid}',
                                            'sendcustid.customerid':'${cardetail.sendcustid.customerid}',
                                            'rececustid.customerid':'${cardetail.rececustid.customerid}',
                                            'sendcity.areaid':'${cardetail.sendcity.areaid}',
                                            'rececity.areaid':'${cardetail.rececity.areaid}',
                                            'orderid':'${cardetail.orderid}'}
                                        ,page: true //开启分页
                                        ,limit:5
                                        ,limits:[5,10,15,20]
                                        ,cols: [[ //表头
