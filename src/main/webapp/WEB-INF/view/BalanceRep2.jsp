								...
								<form action="#" method="post" name="form1"  onsubmit="return false;">
									<table border="0" align="left" cellpadding="2" cellspacing="1">
										<tr>
											...
											<td align="right"><input type="submit"  onclick="customerModify()" value=" 搜 索 "></td>
										</tr>
										<tr>
											<td class="STYLE1" style="BORDER-BOTTOM: #c1dad7 1px solid"
                                        ...
                                        function customerModify() {
                                            layui.use('table', function(){
                                                ...
                                                table.render({
                                                    ...
                                                    ,limits:[5,10,15,20]
                                                    ,cols: [[ //表头
                                                        {field: 'customer.customername', title: '客户名称', width:'25%',align:'center',templet: function(res){
                                                                return res.customer.customername;
                                                            } }
                                                        ,{field: 'paidtype', title: '收(付)款类别', width:'25%',align:'center'}
                                                        ,{field: 'facefee', title: '收(付)款小计', width:'25%',align:'center'}
                                                        ,{field: 'paidtime', title: '收(付)款时间', width:"25%",align:'center',templet: function(res){
