...
<body>
    ...
    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <script language="javascript">
                ...
                <script type="text/javascript">
                    ...
                    layui.use('layer', function(){
                        ...
                        var paidtypeUpdate='${paidtypeUpdate}';
                        if(paidtypeUpdate!=""){
                            layer.open({
                                title:0
                                ,content:paidtypeUpdate
                                ,skin: 'demo-class'
                                ,offset: 'auto'
                                ,anim: 1
                                ,time:2000
                            })
                            if(paidtypeUpdate=="修改成功"){
                ...
                <script type="text/javascript">
                    $(function () {
                        var paidname2='${paid.paidname }'; //获取原来区域名称
                        $("#paidname").blur(function () {
                            var paidname=$(this).val().trim();
                            if (paidname!=""&&paidname!=paidname2){
                                $.ajax({
            ...
            <form action="${pageContext.request.contextPath}/paidtype/paidtypeUpdate.action" method="post" name="form1" onsubmit="return check();">
            ...
            <table width="70%" border="0" align="left" cellpadding="2" cellspacing="1" >
			  <tr>
			    ...
			    <td class="STYLE1"  style="BORDER-BOTTOM: #c1dad7 1px solid"><input type="text" name="paidname" id="paidname" value="${paid.paidname }">&nbsp;&nbsp;&nbsp;<font color="red"><span id="name"></span></font></td>
			  </tr>
			   <tr>
